...
As a reminder, do not start any local dev servers in the background. The local web app dev services are already running, and you can tail the logs at app.log, as needed. The explorer subagent can manually explore the app using MCP Playwright.
