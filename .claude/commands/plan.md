Use the planner subagent to make a comprehensive ultrathink plan to accomplish this.
...
Do not include plans for legacy fallback, unit tests or integration tests or explicitly requested.
