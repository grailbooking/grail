...
Use context7 as needed for code generation, setup or configuration steps, or
library/API documentation. This means you should automatically use the Context7 MCP
tools to get the following library docs without me having to explicitly ask:

- Use library /firebase/firebase-functions for Firebase Functions and Google Cloud Functions SDK and docs.
- Use library /firebase/firebase-js-sdk for other Firebase SDK and docs.
- Use library /mdn/content for modern browser APIs, web APIs, and standards.
- Use library /reactivex/rxjs for RxJS and Observables APIs and docs.
- Use library /websites/tailwindcss for Tailwind CSS 4.1 APIs and docs.
